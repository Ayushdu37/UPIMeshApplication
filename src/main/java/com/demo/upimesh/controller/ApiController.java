...
public class ApiController {
    ...
    @org.springframework.beans.factory.annotation.Value("${upi.mesh.bridge-api-key:}")
    private String configuredBridgeApiKey;
    ...
    public ResponseEntity<?> ingest(
        ...
        if (configuredBridgeApiKey != null && !configuredBridgeApiKey.isBlank()) {
            if (apiKey == null || !configuredBridgeApiKey.equals(apiKey)) {
                return ResponseEntity.status(org.springframework.http.HttpStatus.UNAUTHORIZED)
                        .body(Map.of("error", "Unauthorized bridge node: invalid X-Bridge-Api-Key"));
            }
        }
